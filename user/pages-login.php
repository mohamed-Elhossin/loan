...
if (isset($_POST['login'])) {
  ...
  if ($numOfRows > 0) {
    ...
    echo "<div class=' mt-5  alert alert-warning mx-auto w-20'>
    <h3>   OOOPS! Please try Agein </h3>
        </div>";
  }
}
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                ...
                <form class="row g-3 needs-validation" novalidate method="POST">
                  ...
                  <div class="col-12">
                    <p class="small mb-0">Don't have account? <a href="/loan/user/admins/add.php">Create an account</a></p>
                  </div>
                </form>
